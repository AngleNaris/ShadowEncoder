    ...
    MuiOutlinedInput: {
      styleOverrides: {
        root: {
          ...
          "& .MuiOutlinedInput-notchedOutline": { borderColor: "#3d3946" },
          "&:hover .MuiOutlinedInput-notchedOutline": { borderColor: "#605870" },
          "&.Mui-focused .MuiOutlinedInput-notchedOutline": {
            borderColor: "#6d5da5",
            borderWidth: 1,
            boxShadow: "0 0 0 1px #6d5da5, 0 0 12px -2px rgba(109, 93, 165, 0.4)",
          },
          "&.Mui-focused": { backgroundColor: "#15131a" },
    ...
    MuiMenuItem: {
      styleOverrides: {
        root: {
          ...
          padding: "5px 12px",
          color: "#c6bfd1",
          "&:hover": { backgroundColor: "#232029", color: "#ece8f2" },
          "&.Mui-selected": {
